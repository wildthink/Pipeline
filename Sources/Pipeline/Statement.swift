...
extension Database.Statement {
	...
	func bind(_ values: [Int32], toParameter index: Int) throws {
		precondition(index > 0)
	...
	///
	/// - seealso: [The Carray() Table-Valued Function](https://www.sqlite.org/carray.html)
	func bind(_ values: [Int64], toParameter index: Int) throws {
		precondition(index > 0)
	...
	///
	/// - seealso: [The Carray() Table-Valued Function](https://www.sqlite.org/carray.html)
	func bind(_ values: [Double], toParameter index: Int) throws {
		precondition(index > 0)
	...
	///
	/// - seealso: [The Carray() Table-Valued Function](https://www.sqlite.org/carray.html)
	func bind(_ values: [String], toParameter index: Int) throws {
		precondition(index > 0)
